...
class UploadHandler
{
    ...
    public function __construct($model, $id, $options = null, $initialize = true, $error_messages = null) {
        $this->model = $model;
        $this->id = $id;
        $this->options = array(
            'script_url' => "/INOVACMS/files/",
            'upload_dir' => '/home/inovar52/public_html/arquivos/imagens/'.$this->model.'/'.$this->id.'/',
            'upload_url' => '/arquivos/imagens/'.$this->model.'/'.$this->id.'/',
